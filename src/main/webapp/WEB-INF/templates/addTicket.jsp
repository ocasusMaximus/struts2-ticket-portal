    ...
    <div class="container">
        ...
        <div id="navbarSupportedContent" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active"><a href="${pageContext.request.contextPath}/tickets" class="nav-link">Seznam rezervací</a></li>
                <li class="nav-item"><a href="${pageContext.request.contextPath}/addTicket" class="nav-link">Nová rezervace</a></li>
            </ul>
        </div>
    </div>
</nav>
<div class="form-part">
  ...
  <s:form action="createTicket" method="post" >
    <table class="form-table">
        ...
        <tr>
            <s:select   class="form-field" name="ticket.movie" list="{'Star Wars: Pomsta sithů','Avengers: Endgame','Pulp Fiction', 'John Wick'}" headerKey=""
                      label="Film" />
        </tr>
        <tr>
...
<div class="form-part">
    ...
    <s:form action="updateTicket" method="post" >
        <table class="form-table">
            ...
            <s:hidden name="ticket.id" />
            <tr>
                <s:select   class="form-field" name="ticket.name" list="{'Star Wars: Pomsta sithů','Avengers: Endgame','Pulp Fiction', 'John Wick'}" headerKey=""
                            label="Film" />
            </tr>
            <tr>
                <s:select   class="form-field" name="ticket.language" list="{'Angličtina','Čeština'}"
